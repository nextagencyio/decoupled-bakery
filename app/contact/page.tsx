...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Golden Crust Bakery. We\'d love to hear from you about custom orders, catering, or visiting our bakery.',
  keywords: ['Contact Golden Crust Bakery', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about custom orders, catering, or visiting our bakery? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@goldencrustbakery.com</p>
                    <p className="text-gray-600">support@goldencrustbakery.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Tuesday - Saturday: 6:00 AM - 4:00 PM<br />
                      Sunday: 7:00 AM - 1:00 PM<br />
                      Monday: Closed
                    </p>
                  </div>
                </div>
