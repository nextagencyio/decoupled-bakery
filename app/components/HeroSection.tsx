...
export default function HeroSection({ homepageContent }: HeroSectionProps) {
  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      <Image
        src="https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1920&q=80&fit=crop"
        alt="Golden Crust Bakery fresh bread"
        fill
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/menu"
            className="inline-flex items-center justify-center px-8 py-4 bg-accent-500 text-white rounded-sm hover:bg-accent-400 transition-colors font-semibold text-lg tracking-wide"
          >
            View Our Menu
          </Link>
          <Link
